...
export default function About() {
    return (
        <section className="flex flex-col items-center justify-center text-center py-20 bg-gradient-to-r from-white to-white text-white px-6">
            ...
            <h2 className="text-3xl font-bold mb-6 text-black">ห้างหุ้นส่วนจํากัด <span className="bg-gradient-to-r from-red-700 to-red-500 bg-clip-text text-transparent">อุเอะฮาระเทรดดิ้ง</span></h2>
