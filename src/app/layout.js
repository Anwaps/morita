...
export const metadata = {
  ...
  description: "เว็บไซต์อย่างเป็นทางการของ ห้างหุ้นส่วนจำกัด อุเอะฮาระเทรดดิ้ง จำหน่ายระบบดับเพลิงและอุปกรณ์ดับเพลิงอัตโนมัติ แบรนด์ Morita ครบวงจร ทั้งติดตั้ง บำรุงรักษา และจำหน่ายอุปกรณ์คุณภาพมาตรฐานสากล",
  keywords: [
    "Morita",
    "Miyata",
  ...
  openGraph: {
    ...
    url: "https://www.uehara-trading.co.th", // ใส่โดเมนจริงเมื่อพร้อม
    siteName: "ระบบดับเพลิง Morita Uehara Trading",
    images: [
      {
        url: "/morita-group.png", // รูปโลโก้หรือภาพ Hero
        width: 1200,
        height: 630,
      },
    ],
